...
Although the plot may show some trends, the overall fitting is okay and the model has a relatively high r square hence the model has a relatively high explained variance. 
